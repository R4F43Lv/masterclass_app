      ...
      bottomNavigationBar: BottomNavigationBar(
        ...
        items: [
          BottomNavigationBarItem(
            icon: Image.asset('lib/assets/icons/eather_target.png', height: 24, color: Theme.of(context).highlightColor,),
            label: 'Atividades',
          ),
          BottomNavigationBarItem(
            icon: Image.asset(
          ...
          BottomNavigationBarItem(
            icon: Icon(Icons.person, size: 24, color: Theme.of(context).highlightColor),
            label: 'Sobre o Dev',
          ),
        ],
      ),
